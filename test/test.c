...
static void run_sha224_tests(struct test_data *test_data, size_t number_of_tests, const char *test_name)
{
  ...
  for (size_t i = 0; i < number_of_tests; i++)
  {
    ...
    SHAXXX_STREAMING_ONE_CALL_TEST(test_data[i], sha224_ctx, uint8_t, sha224_init, sha224_feed, sha224_finalize, sha224_to_string);
    SHAXXX_STREAMING_TEST(test_data[i], sha224_ctx, uint8_t, sha224_init, sha224_feed, sha224_finalize, sha224_to_string);
  }
  puts("OK");
}
...
static void run_sha256_tests(struct test_data *test_data, size_t number_of_tests, const char *test_name)
{
  ...
  for (size_t i = 0; i < number_of_tests; i++)
  {
    ...
    SHAXXX_STREAMING_ONE_CALL_TEST(test_data[i], sha256_ctx, uint8_t, sha256_init, sha256_feed, sha256_finalize, sha256_to_string);
    SHAXXX_STREAMING_TEST(test_data[i], sha256_ctx, uint8_t, sha256_init, sha256_feed, sha256_finalize, sha256_to_string);
  }
  puts("OK");
}
...
static void run_sha384_tests(struct test_data *test_data, size_t number_of_tests, const char *test_name)
{
  ...
  for (size_t i = 0; i < number_of_tests; i++)
  {
    ...
    SHAXXX_STREAMING_ONE_CALL_TEST(test_data[i], sha384_ctx, uint8_t, sha384_init, sha384_feed, sha384_finalize, sha384_to_string);
    SHAXXX_STREAMING_TEST(test_data[i], sha384_ctx, uint8_t, sha384_init, sha384_feed, sha384_finalize, sha384_to_string);
  }
  puts("OK");
}
...
static void run_sha512_tests(struct test_data *test_data, size_t number_of_tests, const char *test_name)
{
  ...
  for (size_t i = 0; i < number_of_tests; i++)
  {
    ...
    SHAXXX_STREAMING_ONE_CALL_TEST(test_data[i], sha512_ctx, uint8_t, sha512_init, sha512_feed, sha512_finalize, sha512_to_string);
    SHAXXX_STREAMING_TEST(test_data[i], sha512_ctx, uint8_t, sha512_init, sha512_feed, sha512_finalize, sha512_to_string);
  }
  puts("OK");
}
...
static void run_sha512_224_tests(struct test_data *test_data, size_t number_of_tests, const char *test_name)
{
  ...
  for (size_t i = 0; i < number_of_tests; i++)
  {
    ...
    SHAXXX_STREAMING_ONE_CALL_TEST(test_data[i], sha512_224_ctx, uint8_t, sha512_224_init, sha512_224_feed, sha512_224_finalize, sha512_224_to_string);
    SHAXXX_STREAMING_TEST(test_data[i], sha512_224_ctx, uint8_t, sha512_224_init, sha512_224_feed, sha512_224_finalize, sha512_224_to_string);
  }
  puts("OK");
}
...
static void run_sha512_256_tests(struct test_data *test_data, size_t number_of_tests, const char *test_name)
{
  ...
  for (size_t i = 0; i < number_of_tests; i++)
  {
    ...
    SHAXXX_STREAMING_ONE_CALL_TEST(test_data[i], sha512_256_ctx, uint8_t, sha512_256_init, sha512_256_feed, sha512_256_finalize, sha512_256_to_string);
    SHAXXX_STREAMING_TEST(test_data[i], sha512_256_ctx, uint8_t, sha512_256_init, sha512_256_feed, sha512_256_finalize, sha512_256_to_string);
  }
  puts("OK");
}
